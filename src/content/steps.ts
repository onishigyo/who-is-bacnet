  ...
  },
  {
    ...
    notes: [
      ...
      },
      {
        ...
        confidence: 'standard',
        text: 'I-Am は、もともと規格ではブロードキャストで送ることが求められていました。Addendum 135-2008q でこれが緩和され、ブロードキャストまたはユニキャストのどちらでもよくなっています（ただし Who-Is を送った相手に必ず届く形で送ること）。この図では、尋ねた相手へ返す形で描いています。制作者の実験でも、機器は尋ねた相手へユニキャストで返していました（ステップ4の答え合わせ No.1053：192.168.222.130 → 192.168.222.128）。',
        source:
