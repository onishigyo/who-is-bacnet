...
export const steps: StepContent[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '下の「会話を始める」を押すと、機器がハブに接続し、これまでと同じ室温の読み書きをする様子が並びます。ひとつ押せば図で再生されます。ただし中身は暗号化されていて、傍受しても読めません ── それは次のステップの答え合わせで確かめます。',
    ],
    notes: [
      {
        id: 'sc-std-topology',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '図の下の「持ち込まれた PC を操作する」を押すと、ハブへの接続が拒否される様子が並びます。ひとつ押せば図で再生されます。そのあと、IP と SC の Wireshark を並べた答え合わせで、「読める」と「読めない」の違いを見比べてください。',
    ],
    notes: [
      {
        id: 'sc-std-cert-gate',
